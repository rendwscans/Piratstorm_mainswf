package net.bigpoint.network.messages
{
   ...
   public class MoveRequestMessage implements IMessage
   {
      
      public static const MESSAGE_ID:int = 1017;
      
      private var _posX:int;
      
      private var _posY:int;
      
      public function MoveRequestMessage()
      {
         super();
      }
      ...
      {
         return "\"MoveRequestMessage\": {" + "\"_posX\": \"" + this._posX + "\" " + ", " + "\"_posY\": \"" + this._posY + "\" " + "}";
      }
   }
}
